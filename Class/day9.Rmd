...
Solve chapters *String basics*, *Introduction to stringr* and *Pattern matching with regular expressions* at [DataCamp](https://www.datacamp.com/enterprise/mt5013-ht18/).
...
Combine `readLines` and `str_split` to a simple `.csv`-reader that generates a matrix of strings with the contents of a file.
...
Data from this exercise is downloaded from [Open data of the Swedish Riksdag](https://data.riksdagen.se/) and contains a list of motions proposed by members of the Riksdag, read it by
...
[Strindberg´s Hemsöborna](https://en.wikipedia.org/wiki/The_People_of_Hems%C3%B6) can be downloaded from [Projekt Gutenberg](https://www.gutenberg.org/) (in Swedish) with
```{r}
