---
title: 'Day 10: Collecting data from internet'
output:
  html_document:
    toc: true
    toc_depth: 4    
...
Solve chapters *Downloading Files and Using API Clients*, *Using httr to interact with APIs directly* and *Handling JSON and XML* på [DataCamp](https://www.datacamp.com/enterprise/mt5013-ht18/).
...
<https://cloud.timeedit.net/su/web/stud1/ri157XQQ624Z50Qv27083gZ6y2Y7007Q5Y65Y5.html>

We can use `GET` to import it to R
...
The schedule for room 14 during this semester can be found on

<https://cloud.timeedit.net/su/web/stud1/ri107355X07Z07Q5Z76g0Y40y6076Y31Q09gQY5Q54777.html>
...
Note: at the end of the query you may change `"format": "px"` to `"format": "json"` in order to get a reply in JSON-format. Fetch a table, examine its structure and try to extract a suitable `data.frame`. See [`SCB_KPI_API.R`](https://github.com/MT5013-HT18/Class_files/blob/master/SCB_KPI_API.Rmd) for a simple example.
...
* Convert to a `data.frame` (as the corresponding table in HW4).
